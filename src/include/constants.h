 ...
 */
void register_constant(napi_env env, napi_value exports,
    ...
    switch (constant_type) {
        case CT_UTF_8_STRING:
            napi_create_string_utf8(env, constant_data, strlen(constant_data),
                                    &val);
        ...
        case CT_UINT8_INTEGER:
            ...
            napi_create_uint32(env, *(uint8_t*)constant_data, &val);
            napi_set_named_property(env, exports, binding_name, val);
        ...
        case CT_UINT16_INTEGER:
            // TODO: Check for OOM and what not.
            napi_create_uint32(env, *(uint16_t*)constant_data, &val);
            napi_set_named_property(env, exports, binding_name, val);
            napi_create_reference(env, val, 1, &ref);
            break;
        ...
        case CT_UINT32_INTEGER:
            // TODO: Check for OOM and what not.
            napi_create_uint32(env, *(uint32_t*)constant_data, &val);
            napi_set_named_property(env, exports, binding_name, val);
            napi_create_reference(env, val, 1, &ref);
            break;
